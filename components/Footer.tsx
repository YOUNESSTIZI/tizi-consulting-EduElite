    ...
    <footer className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
      ...
      <div className="container mx-auto px-3 sm:px-4 py-8 sm:py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-6 sm:mb-8">
          ...
          <div className="space-y-3 sm:space-y-4 md:col-span-2">
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-blue-600 to-purple-600 p-1.5 sm:p-2 rounded-xl">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-400">Gestion Scolaire d'Excellence</p>
              </div>
            </div>
          ...
          {/* Contact Info */}
          <div className="space-y-3 sm:space-y-4 md:ml-auto md:text-right md:flex md:flex-col md:justify-end">
            ...
            <div className="space-y-2 sm:space-y-3 text-gray-400 text-xs sm:text-sm">
              ...
              >
                <Mail className="w-4 h-4 group-hover:text-blue-400 transition-colors flex-shrink-0" />
                <span className="break-all">contact@tizi-consulting.fr</span>
              </a>
              <a 
                href="tel:+33745680679"
                className="flex items-center gap-2 hover:text-white transition-colors group md:justify-end"
              >
                <Phone className="w-4 h-4 group-hover:text-blue-400 transition-colors flex-shrink-0" />
              ...
              <a 
                ...
                className="flex items-center gap-2 hover:text-white transition-colors group md:justify-end"
              >
                <span className="w-1 h-1 bg-gray-400 rounded-full group-hover:bg-blue-400 transition-colors flex-shrink-0"></span>
                <span className="break-all">www.tizi-consulting.fr</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700/50 pt-6 sm:pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-3 sm:gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3 md:gap-6 text-gray-400 text-xs sm:text-sm">
