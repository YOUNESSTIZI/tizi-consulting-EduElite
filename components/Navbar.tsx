  ...
  return (
    <nav className="sticky top-0 z-50 w-full">
      ...
      <div className="relative container mx-auto px-3 sm:px-4">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          >
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-blue-600 to-purple-600 p-1.5 sm:p-2 rounded-xl group-hover:scale-110 transition-transform">
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="md:hidden py-3 sm:py-4 border-t border-gray-200/50 animate-in slide-in-from-top">
            ...
            {user ? (
              <>
                ...
                <Link
                  href="/dashboard"
                    ...
                    className="flex items-center gap-3 px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg text-gray-700 hover:bg-white/50 hover:text-blue-600 transition-all"
                  >
                ...
                <button
                  onClick={handleLogout}
                    className="flex items-center gap-3 px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg text-gray-700 hover:bg-red-50 hover:text-red-600 transition-all text-left"
                >
              ...
              <Link
                  href="/contact"
                  onClick={() => setMobileMenuOpen(false)}
                  className="mt-2 px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold hover:from-blue-500 hover:to-purple-500 transition-all shadow-lg flex items-center justify-center gap-2 text-sm sm:text-base"
              >
